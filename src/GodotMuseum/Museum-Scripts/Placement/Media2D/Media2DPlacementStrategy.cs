...
public sealed class Media2DPlacementStrategy : PlacementStrategyBase
{
    ...
    public Media2DPlacementStrategy(Node owner, Node3D displayRoot, Node placesRoot, float cellPadding) : base(owner, displayRoot, placesRoot, GeneratedMediaGroup, "2D media", Log)
    {
